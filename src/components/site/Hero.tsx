...
export function Hero() {
  ...
  return (
    <section
      id="top"
      ref={ref}
      className="relative isolate overflow-hidden pb-32 pt-40 md:pt-52 noise"
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        {/* Eyebrow */}
        <div className="mx-auto flex w-fit animate-[fade-in_1s_ease-out] items-center gap-3 rounded-full border border-border bg-white/5 px-4 py-1.5 text-xs uppercase tracking-[0.25em] text-muted-foreground backdrop-blur">
        ...
        {/* Kinetic headline */}
        <h1 className="mt-8 text-center font-display tracking-tight">
          <span className="block text-[clamp(3rem,9vw,9.5rem)] leading-[0.95]">
          ...
          <span className="mt-2 block text-[clamp(3rem,9vw,9.5rem)] leading-[0.95]">
        ...
        <p
          className="mx-auto mt-8 max-w-2xl text-center text-base text-muted-foreground md:text-lg"
        ...
        >
          <a href="#products" className="btn-primary inline-flex items-center rounded-full px-7 py-3.5 text-sm font-medium">
            Explore the work
          </a>
          <a href="#contact" className="btn-ghost inline-flex items-center gap-2 rounded-full px-7 py-3.5 text-sm font-medium">
            Partner with us
        ...
        {/* Stat strip */}
        <dl className="mx-auto mt-24 grid max-w-4xl grid-cols-3 gap-px overflow-hidden rounded-2xl border border-border bg-border ring-grad">
          {[
            { k: "14k+", v: "Active learners" },
            { k: "60s", v: "Idea → cinematic site" },
            { k: "98%", v: "Target success rate" },
          ].map((s) => (
            <div key={s.v} className="bg-card/70 px-6 py-7 text-left backdrop-blur-md">
              <dt className="font-display text-4xl text-brand-gradient">{s.k}</dt>
              <dd className="mt-2 text-[11px] uppercase tracking-[0.25em] text-muted-foreground">{s.v}</dd>
            </div>
          ))}
        </dl>
      </div>
