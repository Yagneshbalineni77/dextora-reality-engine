      ...
      <div className="mx-auto max-w-6xl px-5 sm:px-6">
        <div className="grid gap-10 sm:gap-12 md:grid-cols-12">
          <div className="md:col-span-5">
            <p className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground sm:text-xs">Capabilities</p>
          ...
          <div className="grid gap-px overflow-hidden rounded-3xl border border-border bg-border sm:grid-cols-2 md:col-span-7">
            {items.map((it) => (
              <div key={it.t} className="bg-card/70 p-5 backdrop-blur transition-colors hover:bg-card sm:p-6">
