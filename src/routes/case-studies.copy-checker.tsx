  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Copy Checker — Dextora Case Study" },
      {
        ...
        content:
          "Months of theory-exam grading, compressed into minutes. The full Copy Checker case study.",
      },
    ],
  }),
});
...
const samples: Sample[] = [
  {
    ...
    rubric: [
      {
        criterion: "Identifies the case and year",
        weight: 2,
        awarded: 2,
        note: "Correctly cites Kesavananda Bharati (1973).",
      },
      {
        criterion: "Explains Article 368 amending power",
        weight: 2,
        awarded: 2,
        note: "Mentions Parliament's power under Art. 368.",
      },
      {
        criterion: "Defines basic structure with examples",
        weight: 4,
        awarded: 3,
        note: "Lists 5 elements; missed secularism and democracy.",
      },
      {
        criterion: "Significance / constitutional protection",
        weight: 2,
        awarded: 1.5,
        note: "Touches on protection but lacks depth on judicial review.",
      },
    ],
    total: 8.5,
    feedback:
  ...
  },
  {
    ...
    rubric: [
      {
        criterion: "Free-body & restoring force setup",
        weight: 2,
        awarded: 2,
        note: "Correct restoring-force expression.",
      },
      {
        criterion: "Small-angle approximation justified",
        weight: 2,
        awarded: 1.5,
        note: "States approximation but does not explain validity.",
      },
      {
        criterion: "Derivation to T = 2π√(L/g)",
        weight: 3,
        awarded: 3,
        note: "Clean SHM analogy and final form.",
      },
      {
        criterion: "States two valid assumptions",
        weight: 1,
        awarded: 1,
        note: "Both assumptions valid.",
      },
    ],
    total: 7.5,
    feedback:
  ...
  {
    question: "Discuss the causes and consequences of the Great Depression of 1929. (12 marks)",
    maxMarks: 12,
    studentAnswer:
    ...
    rubric: [
      {
        criterion: "Multiple causes with explanation",
        weight: 4,
        awarded: 2,
        note: "Mentions overproduction & credit but misses gold standard, agricultural collapse, weak banking regulation.",
      },
      {
        criterion: "Global transmission mechanism",
        weight: 3,
        awarded: 2,
        note: "Brief reference to trade; should explain Smoot-Hawley tariffs and capital flows.",
      },
      {
        criterion: "Economic & social consequences",
        weight: 3,
        awarded: 2,
        note: "Names unemployment but lacks data and welfare-state response (New Deal).",
      },
      {
        criterion: "Political consequences",
        weight: 2,
        awarded: 1.5,
        note: "Notes Nazism; could mention Japanese militarism and shifts in liberal democracies.",
      },
    ],
    total: 7.5,
    feedback:
    ...
    <main className="relative min-h-screen overflow-x-clip bg-background text-foreground">
      ...
      <section className="relative pb-16 pt-32 sm:pb-24 sm:pt-40">
        <div
          ...
          style={{
            background: "linear-gradient(135deg, oklch(0.68 0.18 150), oklch(0.62 0.22 295))",
          }}
        />
        <div className="mx-auto max-w-5xl px-5 sm:px-6">
          ...
          <h1 className="mt-6 font-display text-5xl tracking-tight sm:text-6xl md:text-7xl">
            From <span className="text-brand-gradient italic">4 months</span>
            <br />
            to 3 days.
          </h1>
          <p className="mt-6 max-w-2xl text-base text-foreground/90 sm:text-lg">
            ...
            evaluator that reads, scores and explains every theory-exam answer — at the speed of an
            API call.
          </p>
      ...
      <section className="pb-16">
        <div className="mx-auto max-w-5xl px-5 sm:px-6">
          ...
          <div className="mt-6 grid gap-6 text-sm leading-relaxed text-muted-foreground sm:grid-cols-2 sm:text-base">
            ...
            <p>
              The cost wasn't only time. Examiner fatigue caused inconsistent scoring across
              batches. Students received a number with no per-question feedback. By the time results
              were out, learning gaps had already compounded into the next semester.
            </p>
          </div>
          <ul className="mt-8 grid gap-3 text-sm text-muted-foreground sm:grid-cols-2">
            {[
              ...
              <li
                key={x}
                className="flex items-start gap-2 rounded-xl border border-border bg-card/60 p-4"
              >
                <span
                  className="mt-1.5 h-1 w-3 shrink-0 rounded-full"
      ...
      <section className="pb-16">
        <div className="mx-auto max-w-5xl px-5 sm:px-6">
          ...
          <p className="mt-5 max-w-3xl text-sm leading-relaxed text-muted-foreground sm:text-base">
            Copy Checker ingests scanned answer scripts, segments answers per question, runs
            handwriting OCR, applies the official rubric question-by-question, and emits a
            per-criterion score with cited rationale — fully auditable and examiner-overridable.
          </p>
          ...
          <div className="mt-10 grid gap-px overflow-hidden rounded-2xl border border-border bg-border sm:grid-cols-3">
            {[
              [
                "01 — Ingest & OCR",
                "Scanned scripts segmented per-question. Handwriting OCR with confidence scores.",
              ],
              [
                "02 — Rubric scoring",
                "LLM scores each criterion in the official rubric and cites the answer text.",
              ],
              [
                "03 — Review desk",
                "Examiners only review low-confidence answers. Overrides flow back as training signal.",
              ],
            ].map(([t, b]) => (
        ...
        <div className="mx-auto max-w-5xl px-5 sm:px-6">
          ...
          <div className="mt-10 space-y-8">
            {samples.map((s, i) => (
              <article
                key={i}
                className="ring-grad relative overflow-hidden rounded-3xl border border-border bg-card/60"
              >
      ...
      <section className="pb-24">
        <div className="mx-auto max-w-5xl px-5 sm:px-6">
          ...
          <h2 className="mt-3 font-display text-3xl tracking-tight sm:text-4xl md:text-5xl">
            The same workload, finished in{" "}
            <span className="text-brand-gradient italic">under 72 hours.</span>
          </h2>
          <div className="mt-8 grid gap-5 sm:grid-cols-3">
            {[
              ...
              [
                "Examiner load",
                "100% → ~4%",
                "Humans only review low-confidence and edge-case answers.",
              ],
              [
                "Student feedback",
                "Score → Per-question rationale",
                "Every student gets actionable, rubric-cited feedback.",
              ],
            ].map(([t, k, b]) => (
